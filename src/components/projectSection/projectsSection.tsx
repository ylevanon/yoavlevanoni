...
const projects = [
  {
    name: "OptiRunGen.com",
    description:
      "OptiRunGen is a linear programming application that generates globally optimal running routes based on user preferences. I developed a novel linear programming algorithm for this project and published and presented my findings at IEEE conference in Montreal Canada. The application is currently in development and will be released soon.",
